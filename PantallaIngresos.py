...
def runIngresos():
    ...
    ingresos = Tk()
    ingresos.geometry("500x550")

    ingresos.config(bd=30)
    ingresos.config(relief="ridge")
    ...
    labelDescripcion=Label(ingresos,text="DESCRIPCIÓN:",bg=colorFondo,fg = colorLetra,font=("Rouge",10)).grid(row=2,column=0,padx=10,pady=10)
    txtDescripcion=Text(ingresos,width=19,height=5,bd=5,relief="ridge").grid(row=2,column=1,padx=10,pady=10)
    labelSaldo=Label(ingresos,text="TOTAL DE INGRESOS:",bg=colorFondo,fg = colorLetra,font=("Helvetica",10)).grid(row=3,column=0,padx=10,pady=10)
    ...
    btnGuardar = Button(ingresos,text="Guardar",bd=14,relief="groove").grid(row=4,column=1,padx=10,pady=10)
    btnAtras = Button(ingresos,text="Atras",bd=14,relief="groove").grid(row=4,column=0,padx=10,pady=10)
    ingresos.mainloop()
